...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 627.0, 165.0, 77.0, 22.0 ],
					"text" : "channels 1 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 729.0, 165.0, 87.0, 22.0 ],
					"text" : "channels 1 2 3"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 627.0, 136.0, 223.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 336.0, 165.0, 87.0, 22.0 ],
					"text" : "dmx_ip 3.0.1.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 438.0, 165.0, 87.0, 22.0 ],
					"text" : "dmx_ip 2.0.1.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "bang", "bang", "" ],
					"patching_rect" : [ 336.0, 136.0, 223.0, 22.0 ],
					"text" : "sel 1 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 51.0, 308.0, 222.0, 176.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 151.0, 222.0, 176.0 ],
					"varname" : "sc.dmx.out",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 264.0, 59.0, 22.0 ],
					"text" : "sc.dmx.in",
					"varname" : "sc.dmx.in"
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 114.0, 252.0, 146.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 9.0, 3.0, 252.0, 146.0 ],
					"varname" : "sc.dmx.bank",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 51.0, 51.0, 79.0, 22.0 ],
					"text" : "o.route /bank"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 51.0, 22.0, 149.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 447.5, 294.0, 60.5, 294.0 ],
					"source" : [ "obj-13", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 345.5, 294.0, 60.5, 294.0 ],
					"source" : [ "obj-15", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 636.5, 189.0, 570.0, 189.0, 570.0, 99.0, 60.5, 99.0 ],
					"source" : [ "obj-17", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 0 ],
					"midpoints" : [ 738.5, 198.0, 315.0, 198.0, 315.0, 99.0, 60.5, 99.0 ],
					"source" : [ "obj-18", 0 ]
				}
